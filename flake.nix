  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      systemSettings = {
        ...
        timezone = "Europe/Zagreb"; # select timezone
        locale = "hr_HR.UTF-8"; # select locale
      ...
      userSettings = rec {
        ...
        name = "vp"; # name/identifier
        email = "vedran.puljic1@gmail.com"; # email (used for certain configurations)
        dotfilesDir = "/home/vp/.dotfiles"; # absolute path of the local repo
